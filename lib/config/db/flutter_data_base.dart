...
import '../../repository/entities/dto/dto.dart';
import '../../repository/entities/po/brilliant_time_po.dart';
import '../../tag_manage/model/po/tag_info.dart';

part "flutter_data_base.g.dart";

@Database(version:1, entities: [MediaFileData,TagInfo,MediaTagRelation,AppConfig,BrilliantTimePO]
,views: [MediaTagRelationWithTagName]
)
